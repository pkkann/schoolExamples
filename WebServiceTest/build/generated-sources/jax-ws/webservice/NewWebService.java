...
public interface NewWebService {
    ...
    @RequestWrapper(localName = "lort", targetNamespace = "http://webservice/", className = "webservice.Lort")
    @ResponseWrapper(localName = "lortResponse", targetNamespace = "http://webservice/", className = "webservice.LortResponse")
