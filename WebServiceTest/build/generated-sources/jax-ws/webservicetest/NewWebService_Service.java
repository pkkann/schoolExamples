 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/WebApplication/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WebApplication/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://webservice/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "NewWebServicePort"), NewWebService.class, features);
    }
